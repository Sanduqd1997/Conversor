...
List<calculadora> cal = <calculadora>[
  calculadora("9", Colors.purpleAccent, Icon(Icons.abc)),
  calculadora("8", Colors.purpleAccent, Icon(Icons.abc)),
  calculadora("7", Colors.purpleAccent, Icon(Icons.abc)),
  calculadora("6", Colors.purpleAccent, Icon(Icons.abc)),
  calculadora("5", Colors.purpleAccent, Icon(Icons.abc)),
  calculadora("4", Colors.purpleAccent, Icon(Icons.abc)),
  calculadora("3", Colors.purpleAccent, Icon(Icons.abc)),
  calculadora("2", Colors.purpleAccent, Icon(Icons.abc)),
  calculadora("1", Colors.purpleAccent, Icon(Icons.abc)),
  calculadora("0", Colors.purpleAccent, Icon(Icons.abc)),
  calculadora("Limpiar", Colors.purpleAccent, Icon(Icons.cleaning_services)),
  calculadora("Calcular", Colors.purpleAccent, Icon(Icons.calculate)),
];
